...
| `doc_types`       | `string[]` | No       | —           | Filter by document type name — one of `pdf`, `docx`, `pptx`, `epub`, `xlsx`, `csv`, `md`, `txt`, `html`, `image`, `audio`, `video` (e.g. `["pdf", "md"]`). Filter by type name, not by extension.                                                                                                                                                                                                                                                                      |
...
| `doc_types`                          | `string[]` | Same type names as `search` — `pdf`, `md`, `docx`, `pptx`, `epub`, `xlsx`, `csv`, `txt`, `html`, `image`, `audio`, `video`.                                                                                                                                                                                                                                                                                                                                                   |
