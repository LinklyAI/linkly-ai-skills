...
| `doc_types`       | `string[]` | No       | —           | Filter by document type name — one of `pdf`, `md`, `xlsx`, `csv`, `doc`, `txt`, `docx`, `pptx`, `rtf`, `epub`, `html`, `image`, `audio`, `video` (e.g. `["pdf", "md"]`). Filter by type name, not by extension.                                                                                                                                                                                                                                         |
...
| `doc_types`                          | `string[]` | Same type names as `search` — `pdf`, `md`, `xlsx`, `csv`, `doc`, `txt`, `docx`, `pptx`, `rtf`, `epub`, `html`, `image`, `audio`, `video`.                                                                                                                                                                                                                                                                                                                      |
